...
?>
        ...
        <table id="tabel-prodi" class="table table-striped table-hover border border-primary">
            <Thead>
            <tr>
                <th>No</th>
                <th>Nama Prodi</th>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?p=prodi&aksi=edit&id_edit_prodi=<?= $data['id'] ?>" class="btn btn-warning">Edit</a>
                        <a href="proses_prodi.php?proses=delete&id_hapus_prodi=<?= $data['id'] ?>" class="btn btn-danger" onclick="return confirm('yakin menghapus data ?')">Hapus</a>
                    </td>
                </tr>
            <?php
                $no++;
    ...
    case 'edit':
        ...
        include 'koneksi.php';
        $ambil_prodi = mysqli_query($db, "SELECT * FROM prodi WHERE id='$_GET[id_edit_prodi]'");
        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <form method="post" action="proses_prodi.php?proses=update">
                    ...
                    <div class="mb-2">
                        <input type="hidden" class="form-control border border-primary" id="" name="id" value="<?= $data_prodi['id'] ?>">
                    </div>
